(() => {
  ...
  var require_binary = __commonJS({
    "node_modules/@stablelib/binary/lib/binary.js"(exports) {
      ...
      function writeUint16BE(value, out2, offset) {
        if (out2 === void 0) {
          out2 = new Uint8Array(2);
        }
        if (offset === void 0) {
          offset = 0;
        }
        out2[offset + 0] = value >>> 8;
        out2[offset + 1] = value >>> 0;
        return out2;
      }
      exports.writeUint16BE = writeUint16BE;
      exports.writeInt16BE = writeUint16BE;
      function writeUint16LE(value, out2, offset) {
        if (out2 === void 0) {
          out2 = new Uint8Array(2);
        }
        if (offset === void 0) {
        ...
        out2[offset + 0] = value >>> 0;
        out2[offset + 1] = value >>> 8;
        return out2;
      }
      ...
      function writeUint32BE(value, out2, offset) {
        if (out2 === void 0) {
          out2 = new Uint8Array(4);
        }
        if (offset === void 0) {
          offset = 0;
        }
        out2[offset + 0] = value >>> 24;
        out2[offset + 1] = value >>> 16;
        out2[offset + 2] = value >>> 8;
        out2[offset + 3] = value >>> 0;
        return out2;
      }
      exports.writeUint32BE = writeUint32BE;
      exports.writeInt32BE = writeUint32BE;
      function writeUint32LE(value, out2, offset) {
        if (out2 === void 0) {
          out2 = new Uint8Array(4);
        }
        if (offset === void 0) {
        ...
        out2[offset + 0] = value >>> 0;
        out2[offset + 1] = value >>> 8;
        out2[offset + 2] = value >>> 16;
        out2[offset + 3] = value >>> 24;
        return out2;
      }
      ...
      function writeUint64BE(value, out2, offset) {
        if (out2 === void 0) {
          out2 = new Uint8Array(8);
        }
        if (offset === void 0) {
          offset = 0;
        }
        writeUint32BE(value / 4294967296 >>> 0, out2, offset);
        writeUint32BE(value >>> 0, out2, offset + 4);
        return out2;
      }
      exports.writeUint64BE = writeUint64BE;
      exports.writeInt64BE = writeUint64BE;
      function writeUint64LE(value, out2, offset) {
        if (out2 === void 0) {
          out2 = new Uint8Array(8);
        }
        if (offset === void 0) {
        ...
        writeUint32LE(value >>> 0, out2, offset);
        writeUint32LE(value / 4294967296 >>> 0, out2, offset + 4);
        return out2;
      }
      ...
      function writeUintBE(bitLength, value, out2, offset) {
        if (out2 === void 0) {
          out2 = new Uint8Array(bitLength / 8);
        }
        if (offset === void 0) {
          offset = 0;
        }
        ...
        var div = 1;
        for (var i = bitLength / 8 + offset - 1; i >= offset; i--) {
          out2[i] = value / div & 255;
          div *= 256;
        }
        return out2;
      }
      exports.writeUintBE = writeUintBE;
      function writeUintLE(bitLength, value, out2, offset) {
        if (out2 === void 0) {
          out2 = new Uint8Array(bitLength / 8);
        }
        if (offset === void 0) {
      ...
      function writeFloat32BE(value, out2, offset) {
        if (out2 === void 0) {
          out2 = new Uint8Array(4);
        }
        if (offset === void 0) {
        ...
        var view = new DataView(out2.buffer, out2.byteOffset, out2.byteLength);
        view.setFloat32(offset, value);
        return out2;
      }
      exports.writeFloat32BE = writeFloat32BE;
      function writeFloat32LE(value, out2, offset) {
        if (out2 === void 0) {
          out2 = new Uint8Array(4);
        }
        if (offset === void 0) {
      ...
      function writeFloat64BE(value, out2, offset) {
        if (out2 === void 0) {
          out2 = new Uint8Array(8);
        }
        if (offset === void 0) {
      ...
      function writeFloat64LE(value, out2, offset) {
        if (out2 === void 0) {
          out2 = new Uint8Array(8);
        }
        if (offset === void 0) {
  ...
  var require_chacha = __commonJS({
    "node_modules/@stablelib/chacha/lib/chacha.js"(exports) {
      ...
      function core(out2, input, key) {
        ...
        binary_1.writeUint32LE(x0 + j0 | 0, out2, 0);
        binary_1.writeUint32LE(x1 + j1 | 0, out2, 4);
        binary_1.writeUint32LE(x2 + j2 | 0, out2, 8);
        binary_1.writeUint32LE(x3 + j3 | 0, out2, 12);
        binary_1.writeUint32LE(x4 + j4 | 0, out2, 16);
        binary_1.writeUint32LE(x5 + j5 | 0, out2, 20);
        binary_1.writeUint32LE(x6 + j6 | 0, out2, 24);
        binary_1.writeUint32LE(x7 + j7 | 0, out2, 28);
        binary_1.writeUint32LE(x8 + j8 | 0, out2, 32);
        binary_1.writeUint32LE(x9 + j9 | 0, out2, 36);
        binary_1.writeUint32LE(x10 + j10 | 0, out2, 40);
        binary_1.writeUint32LE(x11 + j11 | 0, out2, 44);
        binary_1.writeUint32LE(x12 + j12 | 0, out2, 48);
        binary_1.writeUint32LE(x13 + j13 | 0, out2, 52);
        binary_1.writeUint32LE(x14 + j14 | 0, out2, 56);
        binary_1.writeUint32LE(x15 + j15 | 0, out2, 60);
      }
  ...
  async function deriveMasterKey(linkKey, passphrase, kdf) {
  ...
  function encryptXChaCha(plaintext, masterKey) {
  ...
  createBtn.addEventListener("click", async () => {
    try {
      ...
      linkEl.value = url;
      log(
        passphrase ? "created. share link + passphrase separately (both required)." : "created. share the link (anyone with the full link can decrypt)."
      );
    } catch (e) {
